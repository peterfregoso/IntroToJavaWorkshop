...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void scare() {
		...
		showScaryImage("eli.jpg");
	}

	private void showScaryImage(String eli) {
		try {
			maze = ImageIO.read(getClass().getResource(eli));
		} catch (Exception e) {
			System.err.println("Couldn't find his image: " + eli);
		}
		repaint();
	}
